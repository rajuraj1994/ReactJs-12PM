...
const ProductFetch = () => {
  ...
  const [products, setProducts] = useState([]) // setProducts is a function that takes in an array of products and sets the state to that array
  ...
  return (
    ...
    <>
      <div className='row'>
        {' '}
        {/* .row is a bootstrap class */}
        {products.map(
          (
            product // .map is a method that takes in an array and returns an array of JSX  // product is a variable that represents each item in the array of products // product is an object that represents each product in the array of products
          ) => (
